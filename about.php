    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 offset-lg-2">
          <div class="options">
            <div class="option active" style="--optionBackground:url(https://buttoncreatives.com/php/woox/assets/images/best-01.jpg);">
            ...
            <div class="option" style="--optionBackground:url(https://buttoncreatives.com/php/woox/assets/images/best-02.jpg);">
               <div class="shadow"></div>
               <div class="label">
                  <div class="icon">
                    <i class="fas fa-expand"></i>
            ...
            <div class="option" style="--optionBackground:url(https://buttoncreatives.com/php/woox/assets/images/best-03.jpg);">
               <div class="shadow"></div>
               <div class="label">
                  <div class="icon">
                    <i class="fas fa-expand"></i>
            ...
            <div class="option" style="--optionBackground:url(https://buttoncreatives.com/php/woox/assets/images/best-04.jpg);">
               <div class="shadow"></div>
               <div class="label">
                  <div class="icon">
                    <i class="fas fa-expand"></i>
            ...
            <div class="option" style="--optionBackground:url(https://buttoncreatives.com/php/woox/assets/images/best-05.jpg);">
               <div class="shadow"></div>
               <div class="label">
                  <div class="icon">
                    <i class="fas fa-expand"></i>
